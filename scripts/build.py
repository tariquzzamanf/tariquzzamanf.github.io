...
metric_note = ('Google Scholar metrics refreshed' if metrics.get('source') == 'google-scholar' else 'Google Scholar metrics supplied by the author')+(' on '+escape(metrics['verified_on']) if metrics['verified_on'] else '')+'.'
if missing_metrics:
...
PERSON = {
    ...
    'sameAs': ['https://scholar.google.com/citations?user=LWB_NzwAAAAJ',
               ...
               'https://huggingface.co/md-tariquzzaman'],
}
